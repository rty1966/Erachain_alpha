...
import utill.Network;
import utill.Peer;
import utill.Synchronizer;
import utill.Transaction;
import utill.BlockGenerator.ForgingStatus;
	...
	public boolean isUpToDate() {
		...
		if (maxPeerWeight > chainWeight) {
			...
			if (true || (maxPeerWeight - chainWeight < pickTarget)) {
				...
				try {
					Block maxBlock = utill.Synchronizer.getBlock(lastBlockSignature, maxHW.c, true);
					if (maxBlock != null) {
						// SAME LAST BLOCK
